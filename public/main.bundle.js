...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__components_day_view_day_view_component__ = __webpack_require__("../../../../../src/app/components/day-view/day-view.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_detailed_view_detailed_view_component__ = __webpack_require__("../../../../../src/app/components/detailed-view/detailed-view.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_critical_errors_view_critical_errors_view_component__ = __webpack_require__("../../../../../src/app/components/critical-errors-view/critical-errors-view.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__layouts_dash_layout_dash_component__ = __webpack_require__("../../../../../src/app/layouts/dash-layout/dash.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__layouts_auth_layout_auth_component__ = __webpack_require__("../../../../../src/app/layouts/auth-layout/auth.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__components_shared_linechart_linechart_component__ = __webpack_require__("../../../../../src/app/components/shared/linechart/linechart.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__components_transactions_view_transactions_view_component__ = __webpack_require__("../../../../../src/app/components/transactions-view/transactions-view.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__components_shared_barchart_barchart_component__ = __webpack_require__("../../../../../src/app/components/shared/barchart/barchart.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__components_errors_view_errors_view_component__ = __webpack_require__("../../../../../src/app/components/errors-view/errors-view.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__components_shared_scatterchart_scatterchart_component__ = __webpack_require__("../../../../../src/app/components/shared/scatterchart/scatterchart.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_23__layouts_auth_layout_auth_component__["a" /* AuthComponent */],
        children: [
    ...
    {
        path: '',
        component: __WEBPACK_IMPORTED_MODULE_22__layouts_dash_layout_dash_component__["a" /* DashComponent */],
        children: [
            { path: 'summary', component: __WEBPACK_IMPORTED_MODULE_19__components_day_view_day_view_component__["a" /* DayViewComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_18__guards_auth_guard__["a" /* AuthGuard */]] },
            { path: 'transactionsview', component: __WEBPACK_IMPORTED_MODULE_25__components_transactions_view_transactions_view_component__["a" /* TransactionsViewComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_18__guards_auth_guard__["a" /* AuthGuard */]] },
            { path: 'errorsview', component: __WEBPACK_IMPORTED_MODULE_27__components_errors_view_errors_view_component__["a" /* ErrorsViewComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_18__guards_auth_guard__["a" /* AuthGuard */]] },
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                ...
                __WEBPACK_IMPORTED_MODULE_19__components_day_view_day_view_component__["a" /* DayViewComponent */],
                __WEBPACK_IMPORTED_MODULE_20__components_detailed_view_detailed_view_component__["a" /* DetailedViewComponent */],
                __WEBPACK_IMPORTED_MODULE_21__components_critical_errors_view_critical_errors_view_component__["a" /* CriticalErrorsViewComponent */],
                __WEBPACK_IMPORTED_MODULE_22__layouts_dash_layout_dash_component__["a" /* DashComponent */],
                __WEBPACK_IMPORTED_MODULE_23__layouts_auth_layout_auth_component__["a" /* AuthComponent */],
                __WEBPACK_IMPORTED_MODULE_24__components_shared_linechart_linechart_component__["a" /* LinechartComponent */],
                __WEBPACK_IMPORTED_MODULE_25__components_transactions_view_transactions_view_component__["a" /* TransactionsViewComponent */],
                __WEBPACK_IMPORTED_MODULE_26__components_shared_barchart_barchart_component__["a" /* BarchartComponent */],
                __WEBPACK_IMPORTED_MODULE_27__components_errors_view_errors_view_component__["a" /* ErrorsViewComponent */],
                __WEBPACK_IMPORTED_MODULE_28__components_shared_scatterchart_scatterchart_component__["a" /* ScatterchartComponent */],
            ],
            imports: [
            ...
            _this.logService.getOtherTechnicalErrors(currentLog).subscribe(function (data) {
                ...
                for (var i = 0; i < _this.otherTechnicalErrors.length; i++) {
                    ...
                    if (_this.yLabels.indexOf(_this.otherTechnicalErrors[i].errors.errorName) == -1) {
                        _this.yLabels.push(_this.otherTechnicalErrors[i].errors.errorName);
                    }
                }
...
var LinechartComponent = /** @class */ (function () {
    ...
    LinechartComponent.prototype.test = function () {
        if (this.mychart) {
            this.mychart.destroy();
        }
    ...
    TransactionsViewComponent.prototype.ngOnInit = function () {
        ...
        this.logService.currentLog.subscribe(function (currentLog) {
            ...
            _this.logService.getTransactionTypeGraph(currentLog).subscribe(function (data) {
                ...
                _this.btttgraph = [];
                _this.testgraph = [];
                _this.test1 = _this.transactionsByType;
                for (var k = _this.logDateOFrom.getHours(), i = 0; i < (_this.logDateOTo.getTime() - _this.logDateOFrom.getTime()) / 3600000; i++, k++) {
                ...
                for (var a = 0; a < _this.transactionsByType.length; a++) {
                    ...
                    _this.dataSet.push(new DataSet(_this.transactionsByType[a].type, _this.colors[a], false, gggraph));
                }
                /**
